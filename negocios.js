...
export const PLANES_CONFIG = {
  gratis: {
    ...
    consultasDniNombresLimite: 0,
    consultasCedulaLimite: 0,
  ...
  semanal: {
    ...
    consultasLimite: 50,
    consultasTelefonosLimite: 4,
    consultasDniNombresLimite: 4,
    consultasCedulaLimite: 4,
    descripcion: '7 Días (Prueba Corta)'
  },
  mensual: {
    tipo: 'pago',
    duracionDias: 30,
    ...
    consultasLimite: 200,
    consultasTelefonosLimite: 10,
    consultasDniNombresLimite: 7,
    consultasCedulaLimite: 8,
    descripcion: '1 Mes (Emprendedor Digital)'
  },
  bimestral: {
    tipo: 'pago',
    duracionDias: 60,
    comprobantesLimite: 2000,
    consultasLimite: 500,
    consultasTelefonosLimite: 18,
    consultasDniNombresLimite: 12,
    consultasCedulaLimite: 12,
    descripcion: '2 Meses (Negocio Estable)'
  },
  // ⚡ RECARGAS: SOLO suman cupos de validación de clientes (DNI/RUC,
  // teléfonos, DNI por nombres y cédula venezolana). No agregan
  // comprobantes ni extienden la duración de la suscripción.
  recarga_basica: {
    tipo: 'recarga',
    duracionDias: 0,
    comprobantesLimite: 0,
    consultasLimite: 110,
    consultasTelefonosLimite: 20,
    consultasDniNombresLimite: 33,
    consultasCedulaLimite: 50,
    descripcion: 'Recarga Básica'
  },
  recarga_estandar: {
    tipo: 'recarga',
    duracionDias: 0,
    comprobantesLimite: 0,
    consultasLimite: 300,
    consultasTelefonosLimite: 31,
    consultasDniNombresLimite: 51,
    consultasCedulaLimite: 77,
    descripcion: 'Recarga Estándar'
  },
  recarga_avanzada: {
    tipo: 'recarga',
    duracionDias: 0,
    comprobantesLimite: 0,
    consultasLimite: 500,
    consultasTelefonosLimite: 42,
    consultasDniNombresLimite: 70,
    consultasCedulaLimite: 105,
    descripcion: 'Recarga Avanzada'
  },
  recarga_pro: {
    tipo: 'recarga',
    duracionDias: 0,
    comprobantesLimite: 0,
    consultasLimite: 1000,
    consultasTelefonosLimite: 53,
    consultasDniNombresLimite: 88,
    consultasCedulaLimite: 132,
    descripcion: 'Recarga Pro'
  },
  recarga_maxima: {
    tipo: 'recarga',
    duracionDias: 0,
    comprobantesLimite: 0,
    consultasLimite: 1500,
    consultasTelefonosLimite: 65,
    consultasDniNombresLimite: 108,
    consultasCedulaLimite: 162,
    descripcion: 'Recarga Máxima'
  }
};
...
export async function otorgarBeneficio(uid, email, montoPagado, processor, paymentRefString, resend, planId) {
  ...
  try {
    ...
    const result = await db.runTransaction(async (t) => {
      ...
      const currentConsultasDniNombresLimite = userData.consultasDniNombresLimite || 0;
      const currentConsultasCedulaLimite = userData.consultasCedulaLimite || 0;
      ...
      // IMPORTANTE: las recargas NO modifican la expiración del plan activo
      // (solo agregan cupos de consulta). Si no hay plan vigente, queda sin
      // expiración (no crean suscripción nueva).
      let newExpiration;
      if (esRecarga) {
        newExpiration = (currentPlanExpiration && currentPlanExpiration > now) ? currentPlanExpiration : null;
      } else if (planConfig.duracionDias === 0) {
      ...
      const nuevosConsultasDniNombresLimite = currentConsultasDniNombresLimite + (planConfig.consultasDniNombresLimite || 0);
      const nuevosConsultasCedulaLimite = currentConsultasCedulaLimite + (planConfig.consultasCedulaLimite || 0);
      ...
      const updateData = {
        ...
        consultasDniNombresLimite: nuevosConsultasDniNombresLimite,
      ...
      if (!esRecarga) {
        updateData.tipoPlan = planId;
        updateData.planStatus = 'active';
        updateData.planExpiration = newExpiration;
      ...
      t.update(pagoDoc, {
        ...
        planOtorgado: {
          ...
          consultasDniNombresLimite: planConfig.consultasDniNombresLimite || 0,
          consultasCedulaLimite: planConfig.consultasCedulaLimite || 0,
